...
merge_control_vars <- function(nsduh_data)
{
  ...
  rename("binge_drinking" = BNGDRK, "illicit_druguse" = ILLEMMON, 
         #"needing_tx"= TXNPILAL, 
         #"sud" = UDPYILAL,"aud_yr" = ABODALC, 
         "heroin_yr"=HERYR, "cocaine_yr"=COCYR, "marijuana_month" = MRJMON)

  return(state_control_long)
}

state_control_long <- merge_control_vars(nsduh_data_wide)
state_control_long21 <- merge_control_vars(nsduh_data_wide_21)
state_control_long
state_control_long21
```
